...
const workspace='ci-v36-download-check-20260919';
...
const config=await req('/api/config');console.log('CONFIG',JSON.stringify(config));assert.equal(config.version,'3.6.0');
...
console.log('DOWNLOAD_V36_PREVIEW_VERIFIED');
